...
describe Virgo do
  ...
  describe '#external_update' do
    ...
    bibls = []; computing_id = ` id -nu `.chomp # log errors as current user
    bibls[0] = FactoryGirl.build(:bibl, title: 'Nova reperta : new discoveries and inventions', id: 16_356, barcode: '3587312-1001', catalog_key: 'u3587312', call_number: 'Outdated CallNo.')
    bibls[1] = FactoryGirl.build(:bibl, title: 'Letters of the Preston family', id: 16_353, barcode: '2387001-1001', catalog_key: 'u2387001', call_number: 'Outdated CallNo.')
    ...
    it "should take a single Bibl and update its attributes from #{@metadata_server}" do
      bibl = FactoryGirl.build(:bibl, title: 'Incorrect title', id: 16_349, barcode: '3679718-1001', catalog_key: 'u3679718', call_number: 'Outdated CallNo.')
