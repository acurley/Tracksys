ActiveAdmin.register MasterFile do
  ...
  batch_action :download_from_archive do |selection|
    MasterFile.find(selection).each(&:get_from_stornext)
      ...
      panel 'General Information' do
        attributes_table_for master_file do
          ...
          row :intellectual_property_notes do |master_file|
            if master_file.creation_date || master_file.primary_author || master_file.creator_death_date
      ...
      panel 'Technical Information', id: 'master_files' do
        attributes_table_for master_file do
          ...
          row :filesize do |master_file|
            "#{master_file.filesize / 1_048_576} MB"
          end
    ...
    div class: 'columns-none', toggle: 'hide' do
      panel 'Digital Library Information', id: 'master_files', toggle: 'show' do
        attributes_table_for master_file do
          ...
          row(:desc_metadata) do|master_file|
            unless master_file.desc_metadata.nil?
              div do
  ...
  member_action :print_image, method: :put do
    ...
    pdf.image "#{Rails.root}/app/assets/images/lib_letterhead.jpg", at: [pdf.bounds.width - 275, pdf.cursor + 5], fit: [275, 275]
    pdf.font("#{Rails.root}/app/assets/fonts/PTF55F.ttf") do
    ...
    if mf.in_dl? && mf.availability_policy_id == 1
