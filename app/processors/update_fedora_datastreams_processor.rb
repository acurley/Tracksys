class UpdateFedoraDatastreamsProcessor < ApplicationProcessor
  ...
  def on_message(message)
    ...
    fail "Parameter 'datastream' is required" if hash[:datastream].blank?
    ...
    if @object.is_a? Unit
      ...
      if @datastream == 'all'
        ...
        on_success "All datastreams for #{@object.bibl.class} #{@object.bibl.id} will be updated"
        ...
        @object.master_files.each do|mf|
          ...
          unless mf.transcription_text.blank?
          ...
          on_success "All datastreams for #{mf.class} #{mf.id} will be updated."
        ...
        on_success "All objects related to #{@object.class} #{@object_id} are being updated."
        ...
        @object.master_files.each do|mf|
          ...
          on_success "JP2K image for #{mf.class} #{mf.id} will be regenerated."
          instance_variable_set("@#{mf.class.to_s.underscore}_id", '')
        end
        on_success "All JP2K images for #{@object.class} #{@object.id} will be updated."
        ...
        on_success "The descMetadata datastream for #{@object.bibl.class} #{@object.bibl.id} will be updated"
        instance_variable_set("@#{@object.bibl.class.to_s.underscore}_id", '')
        ...
        @object.master_files.each do|mf|
          ...
          on_success "The descMetadata datastream for #{mf.class} #{mf.id} will be updated"
          instance_variable_set("@#{mf.class.to_s.underscore}_id", '')
        end
        ...
        on_success "All XML datastreams for #{@object.bibl.class} #{@object.bibl.id} will be updated"
        # Undo instance_variable_set
        instance_variable_set("@#{@object.bibl.class.to_s.underscore}_id", '')
        ...
        @object.master_files.each do|mf|
          ...
          on_success "All XML datastreams for #{mf.class} #{mf.id} will be updated."
      ...
      if @datastream == 'all'
        ...
        unless @object.transcription_text.blank?
      ...
      if @datastream == 'allxml'
        publish :ingest_desc_metadata, bibl_xml_message
        publish :ingest_marc, bibl_xml_message if @object.catalog_key
        publish :ingest_rights_metadata, bibl_xml_message
