...
ActiveRecord::Schema.define(version: 20_140_307_170_741) do
  ...
  add_index 'automation_messages', %w(messagable_id messagable_type), name: 'index_automation_messages_on_messagable_id_and_messagable_type'
  ...
  create_table 'bibls', force: true do |t|
    ...
    t.text 'rels_ext'
    t.text 'solr',                      limit: 2_147_483_647
    t.text 'dc'
    t.text 'rels_int'
  ...
  create_table 'invoices', force: true do |t|
    ...
    t.text 'notes'
    t.binary 'invoice_copy',            limit: 16_777_215
  ...
  add_index 'legacy_identifiers_units', %w(unit_id legacy_identifier_id), name: 'units_legacy_ids_index'
  ...
  create_table 'unit_import_sources', force: true do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.text 'source',     limit: 2_147_483_647
  end
